...
// Extedned grammer to support regex
func (o *StringOperation) MW(left Operand, right Operand) (bool, error) {
	...
	// catch error on regex complilar

	regExpression, regError := regexp.Compile(r)
	if regError != nil {
		return false, regError
	}
	return regExpression.MatchString(l), nil
}
